let show = true
    ...
    const head_text = d3.selectAll('#head_text')
    const legend_text = d3.selectAll('#legend_text')
      ...
      button.on('click', function(){
        if(isToggled){
          ...
          svg.selectAll('.rectangles')
            ...
            .attr('fill',function(d){
              return bar_color(d.killed)
            })
            head_text.text('Drone Stirkes In Pakistan')
            legend_text.text("Obam'a tenure includes the most strikes for any president.")
              svg.selectAll('.numbers')
          svg.selectAll('.numbers')
            .transition()
            .duration(500) 
          ...
          svg.selectAll('.rectangles')
            ...
            .attr('y',function(d){
              return svgHeight - barLength(d.killed) - 45
            })
            .attr('fill',function(d){
              return bar_color_killed(d.killed)
            })
          head_text.text('Civilians Killed By Strikes')
          legend_text.text('Men of military age are not included in the civilian casualities as they were considered a target.')
            svg.selectAll('.numbers')
              .transition()
              .duration(500) 
              .attr('y',function(d,i){
